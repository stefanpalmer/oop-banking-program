...
public class CheckingRegister implements Register {
	
	static RegisterType registerType = RegisterType.CHECKING;
	...
	public CheckingRegister(int registerNumber, Bank bank, String accountID, Double balance, int beginningCheckNumber)
	{
	...
	public String getRegisterInfo() {
		return "<" + registerNumber + ">, <" + bank.getBankInfo() + ">, <" + accountID + ">, <$" 
				+ balance + ">, <" + beginningCheckNumber + ">, <" + endingCheckNumber + ">";
	}
