...
public class SavingsRegister implements Register {
	
	static RegisterType registerType = RegisterType.SAVINGS;
	...
	public SavingsRegister(int registerNumber, Bank bank, String accountID, Double balance, int beginningCheckNumber)
	{
